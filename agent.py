...
def general_chat_func(query: str) -> str:
    """Fallback tool for general conversation."""
    return general_chat.invoke({"input": query})
...
- If a question is unrelated to Nigerian student rights, politely decline and redirect.
- Cite specific sections or policies when available.
